			...
			for hal in range(0,100):#100
				...
				for ba in range(0,36):#36
					...
					for l in range(0,100):
						...
						try:
							...
							try:
								...
								try:
									self.driver.find_element_by_xpath('/html/body/div[3]/div[1]/div[2]/div[2]/div[2]/div['+str(barang)+']/a').click()
									break
								except:
									try:
					...
					try:
						...
						print pesan
						print "======================================"
						# sql = "select * from lazada_product where product_url = '{}'".format(product_url)
						# cur.execute(sql)
						# results = cur.fetchall()
						# if len(results) == 0:
						# 	sql = "INSERT INTO lazada_product VALUES ('{}','{}','{}','{}','{}',{},{},{},{},'{}',{},'{}','{}')".format(kategori,kategori_url,nama_product,product_url,penjual_url,harga_sebelumnya,diskon,potongan_harga,harga,metode_pembayaran,berat,ukuran,garansi)
						# 	print sql
						# 	cur.execute(sql)
						# 	print "======================================"
